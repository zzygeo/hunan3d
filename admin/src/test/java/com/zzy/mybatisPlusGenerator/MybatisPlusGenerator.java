package com.zzy.mybatisPlusGenerator;
...
public class MybatisPlusGenerator {
    private static final String URL = "jdbc:mysql://localhost:3306/model?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowPublicKeyRetrieval=true";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "zzy123456";
    private static final String PROJECT_ROOT_PATH = System.getProperty("user.dir");
    private static final String BASE_PATH = PROJECT_ROOT_PATH + "/system/src/main/java/com/zzy";
    private static final String PARENT_PACKAGE_NAME = "com.zzy";
...
//                         .idType(IdType.AUTO)
                        ...
                        .superClass(MppBaseMapper.class)
                                .fileOverride()
                        // 开启 @Mapper 注解。
